...
3. Enter RANCHER_URL / RANCHER_ACCESS_KEY / RANCHER_SECRET_KEY, if you want to discover all rancher hosts in other environments
3. Select a port for Grafana to listen on (or create a Rancher load balancer pointing to Grafana on port 3000)
4. Click deploy.
